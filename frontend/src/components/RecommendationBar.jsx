...
export default function RecommendationCard({ rec, rank, onClick, playingTrackId, onPreviewChange, onBeforePlayback, isFavorite, onToggleFavorite, onInteraction, onDismiss }) {
